<section class="tf-box-icon create tf-section style7 bg-style">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-12">
                <div class="heading-live-auctions style2 mg-t-3 mg-bt-22">
                    ...
                    <p class="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sollicitudin morbi donec venenatis sed eget pellentesque viverra ut. 
            ...
            <div class="col-xl-8 col-lg-8 col-md-12">
                <div class="sc-box-icon-inner style3">
                    <div class="sc-box-icon">
                        ...
                        <div class="wrap-box">
                            <h3 class="heading"><a href="/connect-wallet">Add Your NFTs</a></h3>
                    ...
                    <div class="sc-box-icon style2">
                        ...
                        <div class="wrap-box">
                            <h3 class="heading"><a href="/connect-wallet">Create Your Collection</a></h3>
                    ...
                    <div class="sc-box-icon">
                        ...
                        <div class="wrap-box">
                            <h3 class="heading"><a href="/connect-wallet">Set Up Your Wallet</a></h3>
                    ...
                    <div class="sc-box-icon style2">
                        ...
                        <div class="wrap-box">
                            <h3 class="heading"><a href="/connect-wallet">List Them For Sale</a></h3>
