        ...
        <div class="row">
            ...
            <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="sc-card-product">
                    ...
                    <div class="card-title">
                        <h5><a href="/item-details-v1">"Sir. Lion Swag #371"</a></h5>
                        <div class="tags">bsc</div>
                    </div>
                    <div class="meta-info">
                        <div class="author">
                            ...
                            <div class="info">
                                <span>Owned By</span>
                                <h6> <a href="/authors-v2">Mason Woodward</a> </h6>
                            </div>
                        </div>
                        <div class="price">
                            <span>Current Bid</span>
            ...
            <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="sc-card-product">
                    ...
                    <div class="card-title">
                        <h5 class="style2"><a href="/item-details-v1">"Living Vase 01 by Lanz...</a></h5>
                        <div class="tags">bsc</div>
                    </div>
                    <div class="meta-info">
                        <div class="author">
