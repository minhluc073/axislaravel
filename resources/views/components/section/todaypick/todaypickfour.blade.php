<section class="tf-section today-pick">
    <div class="themesflat-container">
        <div class="row">
            <div class="col-md-12">
                <div class="heading-live-auctions mg-bt-21">
                    <h2 class="tf-title pad-l-7">
                        Today's Picks</h2>
                    <a href="/explore-v3" class="exp style2">EXPLORE MORE</a>
                </div>
            </div>
            <div class="col-md-12">
                <div class="tf-soft">
            ...
            <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="sc-card-product menu_card style2">
                    <div class="meta-info style">
                        <div class="author">
                            <div class="avatar">
                                <img src="{{asset ('images/avatar/avt-19.jpg') }}" alt="Axies">
                            </div>
                            <div class="info">
                                <span>Collection</span>
                                <h6> <a href="/authors-v2">Creative Art 3D</a> </h6>
                            </div>
                        </div>
                        <div class="menu_card">
                            <div class="dropdown">
                                <div class="icon">
                                    <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_client">Refresh Metadata</a>
                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_client">Share</a>
                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_client">Report</a>
                                        </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="sc-card-product menu_card style2">
                    <div class="meta-info style">
                        <div class="author">
                            <div class="avatar">
                                <img src="{{asset ('images/avatar/avt-20.jpg') }}" alt="Axies">
                            </div>
                            <div class="info">
                                <span>Collection</span>
                                <h6> <a href="/authors-v2">Creative Art 3D</a> </h6>
                    ...
                    <div class="meta-info">
                        <div class="author">
                            <div class="avatar">
                                <img src="{{asset ('images/avatar/avt-25.jpg') }}" alt="Axies">
                            </div>
                            <div class="info">
                                <span>Owned By</span>
                                <h6> <a href="/authors-v2">Ralph Garraway</a> </h6>
            ...
            <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="sc-card-product menu_card style2">
                    <div class="meta-info style">
                        <div class="author">
                            <div class="avatar">
                                <img src="{{asset ('images/avatar/avt-22.jpg') }}" alt="Axies">
                            </div>
                            <div class="info">
                                <span>Collection</span>
                                <h6> <a href="/authors-v2">Creative Art 3D</a> </h6>
                    ...
                    <div class="meta-info">
                        <div class="author">
                            <div class="avatar">
                                <img src="{{asset ('images/avatar/avt-26.jpg') }}" alt="Axies">
                            </div>
                            <div class="info">
                                <span>Owned By</span>
                                <h6> <a href="/authors-v2">Ralph Garraway</a> </h6>
            ...
            <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="sc-card-product menu_card style2">
                    <div class="meta-info style">
                        <div class="author">
                            <div class="avatar">
                                <img src="{{asset ('images/avatar/avt-23.jpg') }}" alt="Axies">
                            </div>
                            <div class="info">
                                <span>Collection</span>
                                <h6> <a href="/authors-v2">Creative Art 3D</a> </h6>
            ...
            <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="sc-card-product menu_card style2">
                    <div class="meta-info style">
                        <div class="author">
                            <div class="avatar">
                                <img src="{{asset ('images/avatar/avt-24.jpg') }}" alt="Axies">
                            </div>
                            <div class="info">
                                <span>Collection</span>
                                <h6> <a href="/authors-v2">Creative Art 3D</a> </h6>
            ...
            <div class="col-md-12 wrap-inner load-more text-center mg-t2">
