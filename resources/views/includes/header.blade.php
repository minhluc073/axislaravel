<header id="header_main" class="header_1 js-header">
                    ...
                    <div class="wrap-box flex">
                        <div id="site-logo" class="clearfix">
                            <div id="site-logo-inner">
                                <a href="/" rel="home" class="main-logo">
                                    <img id="logo_header" src="{{asset ('images/logo/logo_dark.png') }}" alt="nft-gaming" width="133" height="56"
                                        data-retina="images/logo/logo_dark@2x.png" data-width="133"
                                        data-height="56">
                                </a>
                            </div>
                        </div>
                        ...
                        <nav id="main-nav" class="main-nav">
                            <ul id="menu-primary-menu" class="menu">
                                <li class="menu-item current-menu-item menu-item-has-children">
                                    <a href="#">Home</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="{!! url('/'); !!}">Home 1</a></li>
                                        <li class="menu-item"><a href="{!! url('/index-v2'); !!}">Home 2</a></li>
                                        <li class="menu-item"><a href="{!! url('/index-v3'); !!}">Home 3</a></li>
                                        <li class="menu-item"><a href="{!! url('/index-v4'); !!}">Home 4</a></li>
                                        <li class="menu-item"><a href="{!! url('/index-v5'); !!}">Home 5</a></li>
                                        <li class="menu-item"><a href="{!! url('/index-v6'); !!}">Home 6</a></li>
                                        <li class="menu-item"><a href="{!! url('/index-v7'); !!}">Home 7</a></li>
                                        <li class="menu-item"><a href="{!! url('/index-v8'); !!}">Home 8 ( Special )</a></li>
                                        <li class="menu-item menu-item-has-children">
                                            <a href="#">Slider Styles</a>
                                            <ul class="sub-menu">
                                                <li class="menu-item"><a href="{!! url('/slider-typer-text'); !!}">Text Type</a></li>
                                                <li class="menu-item"><a href="{!! url('/slider-scroll-text'); !!}">Text Scroll</a></li>
                                                <li class="menu-item"><a href="{!! url('/slider-rotate-text'); !!}">Text Rotate</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-item menu-item-has-children">
                                    <a href="#">Explore</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="{!! url('/explore-v1'); !!}">Explore Style 1</a></li>
                                        <li class="menu-item"><a href="{!! url('/explore-v2'); !!}">Explore Style 2</a></li>
                                        <li class="menu-item"><a href="{!! url('/explore-v3'); !!}">Explore Style 3</a></li>
                                        <li class="menu-item"><a href="{!! url('/explore-v4'); !!}">Explore Style 4</a></li>
                                        <li class="menu-item"><a href="{!! url('/auctions'); !!}">Live Auctions</a></li>
                                        <li class="menu-item"><a href="{!! url('/item-details-v1'); !!}">Item Details</a></li>
                                        <li class="menu-item"><a href="{!! url('/item-details-v2'); !!}">Item Details 2</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item menu-item-has-children">
                                    <a href="#">Activity</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="{!! url('/activity-v1'); !!}">Activity 1</a></li>
                                        <li class="menu-item"><a href="{!! url('/activity-v2'); !!}">Activity 2</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item menu-item-has-children">
                                    <a href="#">Community</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item"><a href="{!! url('/blog-details'); !!}">Blog Details</a></li>
                                        <li class="menu-item"><a href="{!! url('/help-center'); !!}">Help Center</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item menu-item-has-children">
                                    <a href="#">Pages</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="{!! url('/authors-v1'); !!}">Authors 1</a></li>
                                        <li class="menu-item"><a href="{!! url('/authors-v2'); !!}">Authors 2</a></li>
                                        <li class="menu-item"><a href="{!! url('/connect-wallet'); !!}">Wallet Connect</a></li>
                                        <li class="menu-item"><a href="{!! url('/create-item'); !!}">Create Item</a></li>
                                        <li class="menu-item"><a href="{!! url('/profile'); !!}">Edit Profile</a></li>
                                            
                                        <li class="menu-item"><a href="{!! url('/ranking'); !!}">Ranking</a></li>
                                        <li class="menu-item"><a href="{!! url('/login'); !!}">Login</a></li>
                                        <li class="menu-item"><a href="{!! url('/signup'); !!}">Sign Up</a></li>
                                        <li class="menu-item"><a href="{!! url('/no-result'); !!}">No Result</a></li>
                                ...
                                <li class="menu-item  menu-item-has-children">
                                    <a href="#">Contact</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="{!! url('/contact-v1'); !!}">Contact 1</a></li>
                                        <li class="menu-item"><a href="{!! url('/contact-v2'); !!}">Contact 2</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav><!-- /#main-nav -->   
                        <div class="flat-search-btn flex">
                            ...
                            <div class="sc-btn-top mg-r-12" id="site-header">
                                <a  href="/connect-wallet" id="connectbtn" class="sc-button header-slider style style-1 wallet fl-button pri-1"><span>Wallet connect
                                </span></a>
                            </div>
                            ...
                            <div class="admin_active" id="header_admin">
                                <div class="header_avatar">
                                    ...
                                    <div class="popup-user">
                                        <img class="avatar" src="{{asset ('images/avatar/avt-5.jpg') }}" alt="avatar"/>
    ...
    <div class="mode_switcher">
        ...
        <a href="#" class="light d-flex align-items-center">
            <img src="{{asset ('images/icon/sun.png') }}" alt="Axies">
        </a>
        <a href="#" class="dark d-flex align-items-center is_active">
            <img id="moon_dark" src="{{asset ('images/icon/moon-2.png') }}" alt="Axies">
        </a>
    </div>
</header>