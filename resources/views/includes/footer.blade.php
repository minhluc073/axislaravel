        ...
        <div class="row">
            <div class="col-lg-3 col-md-12 col-12">
                <div class="widget widget-logo">
                    <div class="logo-footer" id="logo-footer">
                        <a href="/">
                            <img id="logo_footer" src="{{asset ('images/logo/logo_dark.png') }}" alt="nft-gaming" width="135" height="56"
                            data-retina="images/logo/logo_dark@2x.png" data-width="135"
                            data-height="56">
                        </a>
                    </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-5 col-5">
                <div class="widget widget-menu style-1">
                    ...
                    <ul>
                        <li><a href="/authors-v1">Authors</a></li>
                        <li><a href="/connect-wallet">Collection</a></li>
                        <li><a href="/profile">Author Profile</a></li>
            ...
            <div class="col-lg-2 col-md-4 col-sm-7 col-7">
                <div class="widget widget-menu style-2">
                    ...
                    <ul>
                        ...
                        <li><a href="/item-details-v1">Item Details</a></li>
                        <li><a href="/activity-v1">Activity</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-5 col-5">
                <div class="widget widget-menu fl-st-3">
                    ...
                    <ul>
                        <li><a href="/explore-v1">Explore</a></li>
                        <li><a href="/contact-v1">Contact Us</a></li>
