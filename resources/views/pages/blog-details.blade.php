            ...
            <div class="wrap-flex-box style">
                <div class="post">
                    <div class="inner-content">
                        ...
                        <div class="image">
                            <img src="{{asset ('images/blog/thumb-7.jpg') }}" alt="Axies">
                        </div> 
                        <div class="inner-post mg-t-40">
                            ...
                            <div class="image-box">
                                <img src="{{asset ('images/blog/thumb1_details.jpg') }}" alt="Axies">
                                <img src="{{asset ('images/blog/thumb2_details.jpg') }}" alt="Axies">
                            </div>
                        </div>   
                        <div class="inner-post mg-t-22">
                            ...
                            <div class="image">
                                <img src="{{asset ('images/blog/thumb-6.jpg') }}" alt="Axies">
                            </div>
                        </div>       
                ...
                <div class="side-bar details">
                    <div class="widget widget-recent-post mg-bt-43">
                        ...
                        <ul>
                            <li class="box-recent-post">
                                <div class="box-feature"><a href="/blog-details"><img src="{{asset ('images/box-item/icon1-recont-post.jpg') }}" alt="Axies"></a></div>
                                <div class="box-content">
                                    <a href="/blog-details" class="title-recent-post">6 Make Mobile Website Faster</a>
                                    <span><span class="sub-recent-post">Lorem ipsum dolor sit amer....</span><a href="/blog" class="day-recent-post">August 10, 2021</a></span>
                                </div>
                            </li>
                            <li class="box-recent-post">
                                <div class="box-feature"><a href="/blog-details"><img src="{{asset ('images/box-item/icon2-recont-post.jpg') }}" alt="Axies"></a></div>
                                <div class="box-content">
                                    <a href="/blog-details" class="title-recent-post">Experts Web Design Tips</a>
                                    <span><span class="sub-recent-post">Lorem ipsum dolor sit amer....</span><a href="/blog" class="day-recent-post">August 22, 2021</a></span>
                                </div>
                            </li>
                            <li class="box-recent-post">
                                <div class="box-feature"><a href="/blog-details"><img src="{{asset ('images/box-item/icon3-recont-post.jpg') }}" alt="Axies"></a></div>
                                <div class="box-content">
                                    <a href="/blog-details" class="title-recent-post">Importance Of Web Design</a>
                                    <span><span class="sub-recent-post">Lorem ipsum dolor sit amer....</span><a href="/blog" class="day-recent-post">August 20, 2021</a></span>
                                </div>
                            </li>
                            <li class="box-recent-post">
                                <div class="box-feature"><a href="/blog-details"><img src="{{asset ('images/box-item/icon4-recont-post.jpg') }}" alt="Axies"></a></div>
                                <div class="box-content">
                                    <a href="/blog-details" class="title-recent-post">Avoid These Erros In UI Design</a>
                                    <span><span class="sub-recent-post">Lorem ipsum dolor sit amer....</span><a href="/blog" class="day-recent-post">August 12, 2021</a></span>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="widget widget-tag style-1">
                        ...
                        <ul>
                            <li><a href="/blog" class="box-widget-tag">Bitcoin</a></li>
                            <li><a href="/blog" class="box-widget-tag">NFT</a></li>
                            <li><a href="/blog" class="box-widget-tag">Bids</a></li>
                            <li><a href="/blog" class="box-widget-tag">Digital</a></li>
                            <li><a href="/blog" class="box-widget-tag">Arts</a></li>
                            <li><a href="/blog" class="box-widget-tag">Marketplace</a></li>
                            <li><a href="/blog" class="box-widget-tag">Token</a></li>
                            <li><a href="/blog" class="box-widget-tag">Wallet</a></li>
                            <li><a href="/blog" class="box-widget-tag">Crypto</a></li>
                        </ul>
                    </div>
                </div>
            </div>
